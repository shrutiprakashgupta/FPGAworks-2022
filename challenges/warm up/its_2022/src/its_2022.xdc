...
#7 segment display
set_property PACKAGE_PIN W7 [get_ports {flag_led[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_led[0]}]
set_property PACKAGE_PIN W6 [get_ports {flag_led[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_led[1]}]
set_property PACKAGE_PIN U8 [get_ports {flag_led[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_led[2]}]
set_property PACKAGE_PIN V8 [get_ports {flag_led[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_led[3]}]
set_property PACKAGE_PIN U5 [get_ports {flag_led[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_led[4]}]
set_property PACKAGE_PIN V5 [get_ports {flag_led[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_led[5]}]
set_property PACKAGE_PIN U7 [get_ports {flag_led[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_led[6]}]

#set_property PACKAGE_PIN V7 [get_ports dp]							
	#set_property IOSTANDARD LVCMOS33 [get_ports dp]

set_property PACKAGE_PIN U2 [get_ports {flag_enable[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_enable[0]}]
set_property PACKAGE_PIN U4 [get_ports {flag_enable[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_enable[1]}]
set_property PACKAGE_PIN V4 [get_ports {flag_enable[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_enable[2]}]
set_property PACKAGE_PIN W4 [get_ports {flag_enable[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {flag_enable[3]}]
